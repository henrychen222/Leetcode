...
const main = () => {
    ...
    pr()
    let debug2 = new BookMyShow(5, 9);
    pr(debug2.scatter(2, 2)); // true
    pr(debug2.gather(7, 2)); // [0, 2]
    pr(debug2.gather(4, 1)); // [1, 0]
    pr(debug2.gather(6, 2)); // [2, 0]
    pr(debug2.scatter(2, 1)); // true
}
