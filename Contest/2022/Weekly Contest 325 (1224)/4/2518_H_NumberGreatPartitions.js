/*
 * 12/24/22 night
 * https://leetcode.com/contest/weekly-contest-325/problems/number-of-great-partitions/
 * 
 * reference:
...
const knapsack_01 = (a, k) => {
    ...
    // pr(dp);
    let bad = ll(sm(dp) * 2), tot = powmod(2n, ll(a.length), bmod), good = minus_mod(tot, bad, bmod);
    // pr(bad, tot, good)
    return good;
};
